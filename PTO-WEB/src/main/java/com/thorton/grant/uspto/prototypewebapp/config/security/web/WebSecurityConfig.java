...
public class WebSecurityConfig  extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers( "/.well-known/**","/resources/**","/h2-console/**", "/console/**","/webjars/**","/registration/**","/","/home","/newUser","/aboutUs/**","/contact/**","/public/**","/owner/**","/registrationConfirm/**","/CompleteRegistration/**","/REST/**","/recovery/**").permitAll()
